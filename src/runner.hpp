...
inline void moveValue(long long &dest, long long &src) { dest = src; }

inline void moveValue(int &dest, int &src) { dest = src; }

inline void moveImmediate(long long &reg, int value) { reg = value; }

inline void moveImmediate(int &reg, int value) { reg = value; }

inline void execute(std::vector<int> &fileContent) {
